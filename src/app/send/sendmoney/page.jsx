    ...
    return (
        <div className="send-money-container">
            <div className="send-money-content">
                ...
                <button className="send-button" onClick={handleSendMoney}>Send Money</button>
                ...
                {isSuccess && (
                    <div className="success-overlay">
                        <div className="success-content">
                            ...
                            <a href="/transaction">
                                <button className="success-button" onClick={handleViewReceipt}>View receipt</button>
                            </a>
                            <a href="/">
                                <button className="success-button" onClick={handleHome}>Home</button>
                            </a>
                        </div>
                    </div>
                )}
